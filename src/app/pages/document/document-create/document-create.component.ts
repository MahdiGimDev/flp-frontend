...
*/
  ...
  constructor(
    ...
    private missionService: DocumentService,
...
/*if (!this.selectedUser) {
  this.errorMessageMission = "user is required";
  return false;
}*/
...
this.document = {
 ...
 // file: this.documentForm.value.file,
  file: this.documentForm.get("file").value,
