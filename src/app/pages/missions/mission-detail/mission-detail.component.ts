...
import {
  skillsModel,
  MissionCreateModel,
  JwtPayload, certifsModel, tarifModel
  ...
  this.totalht=(parseInt(this.tarifclient)*this.mission.period);
    ...
    (
      (
        ...
        parseInt(this.tarifclient))*this.mission.period;
...

{
         ...
         {
          text: 'Conditions de paiement : 30 jours après la réception de la facture.',
          style:'tel4'
         
       },

       {
        text: 'Nom du compte : Freelance Provider - RIB 08 008 0000 6751024965 39- Agence El Menzah (67)IBAN TN59 0800 80006751 0249 6539 Carte d Identification Fiscale: 1624513X',
        style:'tel5'
     ...
     exs.push(
      [{
          columns: [
            ...
            {
              text: 'Nom : ' +experience.client.lastName+' '+ experience.client.firstName ,
            },
            {
    ...
    return {
      ...
      table: {
        ...
        body: [
          ...
          {
            text: [(parseInt(this.tva)*((parseInt(this.tarifclient))*(educations.period))) /100]+ '€',
            style: 'tableHeader3'
          },
          ...
          {
            text: [((parseInt(this.tarifclient))*(educations.period))+
              ((parseInt(this.tva))*((parseInt(this.tarifclient))*(educations.period))/100
              )
            ]+'' +'€',
            style: 'tableHeader6'
          },
...

{
     columns: [
        ...
        {
         text: 'Conditions de paiement : 40  jours après la fin de la mission.',
         style:'tel4'
    ...
    exs.push(
     [{
         columns: [
           ...
           {
             text: 'Nom : ' +experience.user.firstName+' '+ experience.user.lastName ,
           },
           {
